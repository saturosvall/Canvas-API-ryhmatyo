...
class Lobstermorph extends Enemy {
    constructor(game) {
        ...
        this.frameX = 0;
        this.frameY = Math.floor(Math.random() * 4);
        this.maxFrame = 14; //how many pics in a row
        this.lives = 8;
        this.maxLives = this.lives;
    }
}
...
class Beetlemorph extends Enemy {
    constructor(game) {
        ...
        this.frameX = 0;
        this.frameY = Math.floor(Math.random() * 4);
        this.maxFrame = 3; //how many pics in a row
        this.lives = 1;
        this.maxLives = this.lives;
    }
}
...
class Game {
    constructor(canvas) {
        ...
        this.enemyTimer = 0;
        this.enemyInterval = 1000; // how often enemies appears

        this.spriteUpdate = false;
        this.spriteTimer = 0;
        this.spriteInterval = 150;
        this.score = 0;
        this.winningScore = 50; // limit where you win
        this.lives = 20;  // power
    ...
    render(context, deltaTime) {
        ...
        // periodically activate an enemy object
        if (!this.gameOver) {
    ...
    // reuseable check collision method
    checkCollision(a, b) {
        const dx = a.x -b.x;
        const dy = a.y -b.y;
        const distance = Math.hypot(dx, dy);
